      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="{{ route('authers') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Authers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('create.auther') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Auther</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="{{ route('create.about') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create about</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="{{ route('create.contact') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Contacts</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="{{ route('create.list') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create list</p>
                </a>
              </li>
